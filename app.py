...
c.execute('''CREATE TABLE IF NOT EXISTS analyzed_text (id INTEGER PRIMARY KEY AUTOINCREMENT, text TEXT, sentiment TEXT, keywords TEXT, timestamp DATETIME)''')
conn.commit()
...
def result():
    ...
    c.execute('''SELECT * FROM analyzed_text ORDER BY id DESC''')
